...
var TT=%%TT%%;
var BLK={
  "CO2":{max:69.9,hdr:"Warning: Input pressure exceeded ⚠  Max. pressure:69.9 bar ⚠",msg:"Risk: Liquid Phase CO\u2082\nPressure Exceeds Limit!"},
  "CH4":{max:250,hdr:"Warning: Input pressure exceeded ⚠  Max. pressure:250 bar ⚠",msg:"Risk: Flammable Gas\nPressure Exceeds Safe Limit!"},
  "C2H2":{max:17,hdr:"Warning: Input pressure exceeded ⚠  Max. pressure:17 bar ⚠",msg:"Risk: Decomposition Hazard\nMax 17 bar for Acetylene!"},
  "H2S":{max:20,hdr:"Warning: Input pressure exceeded ⚠  Max. pressure:20 bar ⚠",msg:"Risk: Toxic Gas\nPressure Exceeds Safe Limit!"}
};
var GMAX=2001;
...
function evalM(gas,Pi){
  if(Pi>GMAX)return{m:"D",hdr:"Warning: Input pressure exceeded ⚠  Max. pressure:2001 bar ⚠",blocked:true,msg:"Risk: Pressure >2001 bar\nExceeds Maximum Limit!"};
