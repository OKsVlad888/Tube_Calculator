...
html,body{
  ...
  color:#00e5cc;
  /* base font = 14px (Word pt14 equivalent) */
  font-size:14px;
}
...
/* ══════════════════════════════════════════════════
   CENTERING WRAPPER
   Covers the HUD's empty rectangle (left:1%, top:21%,
   width:54%, height:44%) and centres the panel inside it.
   ══════════════════════════════════════════════════ */
#panel-wrapper{
  position:fixed;
  left:1%;
  ...
  z-index:500;
  pointer-events:none;   /* pass-through outside the panel */
}

/* ══════════════════════════════════════════════════
   CALCULATOR PANEL
   • Centred inside the wrapper
   • width/height auto-fit content (no fixed size)
   • max constraints prevent overflow
...
#calc-panel{
  ...
  max-width:96%;
  max-height:96%;
  overflow:hidden;        /* NO scroll bar at all */
...
.sr label{font-size:14px;letter-spacing:1px;text-transform:uppercase;color:rgba(0,229,204,0.7)}
.sr select{
...
.frow label{font-size:14px;color:rgba(0,229,204,0.85);letter-spacing:0.3px}
.frow input{
  width:100%;
  background:rgba(0,15,13,0.98);color:#00ffee;
  border:1px solid rgba(0,229,204,0.38);border-radius:2px;
  padding:4px 7px;font-family:'Courier New',monospace;font-size:14px;outline:none;
}
...
/* ── Caption + button ── */
.cap{grid-column:1/-1;font-size:11px;color:rgba(0,229,204,0.4);letter-spacing:1px;margin:2px 0}
#cbtn{
  grid-column:1/-1;
...
.rbox.ok small{font-weight:normal;font-size:13px;color:rgba(0,255,200,0.7)}
.rbox.err{
...
/* ── Spec table ── */
.sp-title{font-size:14px;letter-spacing:1px;color:#00e5cc;text-transform:uppercase;margin:5px 0 3px;font-weight:bold}
...
.stbl th{
  ...
  padding:4px 7px;text-align:left;letter-spacing:1px;font-size:12px;text-transform:uppercase;
}
.stbl td{
  color:rgba(0,229,204,0.82);border-bottom:1px solid rgba(0,229,204,0.1);padding:3px 7px;font-size:13px;
}
